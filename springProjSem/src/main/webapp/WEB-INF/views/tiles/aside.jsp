...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">상품관리항목:</h6>
                <a class="collapse-item" href="/product/products">상품 목록</a>
                <a class="collapse-item" href="/product/addProduct">상품 등록</a>
            </div>
        </div>
    </li>
    <!-- 회원관리 메뉴 - Pages Collapse Menu -->
    <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">회원관리항목:</h6>
                <a class="collapse-item" href="/preiviews/list">회원 목록</a>
                <a class="collapse-item" href="/preiviews/write">회원 등록</a>
            </div>
        </div>
    </li>
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item">
        <a class="nav-link" href="/resources/sbadmin2charts.html">
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item">
        <a class="nav-link" href="/resources/sbadmin2tables.html">
