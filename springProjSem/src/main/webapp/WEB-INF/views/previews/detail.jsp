        ...
        <!-- Nested Row within Card Body -->
            <div class="row">
               <!-- 왼쪽 대표 이미지 -->
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        <!-- form에서 modelAttribute 는 ID이다. -->
                        <form:form modelAttribute="memVO" class="user" method="post" action="/previews/deletePost" onsubmit="return fn_chk()">
                        ...
                        <form:hidden path="userId"/>
                            ...
                            <button id="btnsubmit" type="submit" class="btn btn-primary btn-user btn-block" disabled="disabled">확인</button>
...
<script type="text/javascript">
   ...
   $(function() {
      $("#edit").on("click", function() {
         ...
         $("img").remove();
         //submit시 readonly="true"는 데이터가 넘어가고,
		//         disabled="disabled"는 데이터가 안넘어감
      ...
      $("#userPw").focusout(function(){
		 ...
		 console.log("data : " + userPw ,  userNo)
    	   let data = {
    			   "userPw" : userPw,
    			   "userNo" : userNo 
