	   ...
	   <tr>
	     ...
	     <td>${memVO.userName}</td>
	   	 ...
	   	 <c:if test="${attachVO.filename!=null}">
	   	 	<img src="/resources/images/file.png" style="width:30px; cursor:pointer;" onclick="fn_download('${attachVO.filename}')"/>
	   	 </c:if>
	   	 </c:forEach>
	   	 </td>
	   </tr>
...
function fn_download(param){
	...
	//param : /2022/08/16abf82e54-c353-4062-a603-8e8b11a34637_tomcate.PNG
