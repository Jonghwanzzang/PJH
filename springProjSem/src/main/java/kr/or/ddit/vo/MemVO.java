 ...
 */
/*
  입력값 검증 규칙 : 입력값 검증 규칙은 Bean Validation이 제공하는 제약 에너테이션으로 설정
...
public class MemVO {
	...
	@NotBlank	// Not Blanck --> 필수 입력 검증 규칙 지정
	private String userId;
	@NotBlank
	private String userPw;
	
	@NotBlank // 문자열이 null이 아니고 trim한 길이가 3보다 작은 것을 검사 
	@Size(max=3)
