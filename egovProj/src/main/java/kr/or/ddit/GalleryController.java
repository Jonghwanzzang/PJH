...
//		model.addAttribute("attach",attach);
	...
	public List<BookVO> registPost(@RequestBody BookVO vo) {
		log.info("controller vo :" + vo.toString());
		String title = vo.getTitle();
	...
	// 요청파라미터 : uploadFile[] , book Id = > 폼으로 오므로 ReqeustBody는 사용하지않음
	...
	/**
	   ...
	   public Map<String,String> uploadAjaxAction(MultipartFile[] uploadFile, @RequestParam String bookId){
	      ...
	      int seq = this.bookserviceImpl.getSeq(bookId);
	      ...
	      int rslt = this.bookserviceImpl.uploadAjaxAction(attachVOList);
