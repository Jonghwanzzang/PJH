...
<!-- 
	스프링 시큐리티 표현식
	  ...
	  - hasAnyRole([role, role2]) : 여러 roles 중에서 하나라도 해당하는 롤이 있으면true(or처럼)
	  ...
	  - isFullyAuthenticated() : Remember-me로 인증된 것이 아닌 일반적인 방법으로 인증된 
	  							  사용자인 경우 true
	  - 
 -->
...
<nav class="navbar navbar-expand navbar-dark bg-dark">
	...
	<div class="container">
		...
		<div style="float:right">
			<!-- 인증된 사용자인 경우 true, 로그인 했을 때만 로그아웃 버튼이 보임 -->
		
			<sec:authorize access="isAuthenticated()"> 
			<form action="/logout" method="post">
			<button type="submit" class="btn btn-secondary" style="--bs-btn-padding-y">
			 logout
			</button>
				<sec:csrfInput/>
			</form>
...
<!-- 버튼 클릭 시 Model 창이 띄워짐
	- button의 data-bs-toggle 속성을 "modal"로 설정해야 함
	- data-bs-target 속성은 출력할 modal div객체의 id를 넣어 줌
          ...
          <div class="bd-example">
           ...
           <ul class="list-group list-group-flush">
             ...
             <li class="list-group-item">
                 ...
                 <input type="text" class="form-control" id="memName" value="<sec:authentication property='principal.memberVO.memName'/>">
             </li>
             <li class="list-group-item">
