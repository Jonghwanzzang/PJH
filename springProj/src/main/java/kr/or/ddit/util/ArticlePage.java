...
public class ArticlePage<T>  {
	...
	private int totalPages;		//시작 페이지 번호
	private int startPage;		// 시작 페이지 번호
	private int endPage;		// 종료 페이지 번호
	private int pageSize=5;	// 페이징 사이즈
	private List<T> content;	// db 데이터
	...
	//totalPages(페이지 수) --> 전체 글 수 / 한 화면에 보여질 목록의 행 수 
	...
	//종료페이지번호(endPage) > 전체 페이지수(totalPage)
