...
public class FileUploadUtil {
   private String uploadFolder = "C:\\Users\\PC-10\\Desktop\\springProduct\\src\\main\\webapp\\resources\\upload";
   ...
   public int fileUploadAction(MultipartFile[] multipartFiles, String tid) {
      ...
      // SEQ(자동증가), TID , ATTACH_NAME,ATTACH_SIZE
      ...
      log.info("fileuploadutil :  " + attachVOList);
